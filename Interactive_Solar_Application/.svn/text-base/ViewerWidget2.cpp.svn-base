...
ViewerWidget2::ViewerWidget2(osg::Node* scene)
{
...
ViewerWidget2::ViewerWidget2(osgViewer::ViewerBase* viewer) :
_viewer( viewer )
{
    if ( !_viewer.valid() )
    {
...
ViewerWidget2::~ViewerWidget2()
{
    ...
    OE_DEBUG << "ViewerWidget2::DTOR" << std::endl;
}


void
ViewerWidget2::setTimerInterval(int milliseconds)
{
...
void ViewerWidget2::installFrameTimer()
{    
...
void ViewerWidget2::createViewer()
{
...
void ViewerWidget2::reconfigure( osgViewer::View* view )
{
    if ( !_gc.valid() )
    {
...
void ViewerWidget2::paintEvent(QPaintEvent* e)
{
