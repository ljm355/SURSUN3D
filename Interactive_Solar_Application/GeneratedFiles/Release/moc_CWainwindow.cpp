/****************************************************************************
** Meta object code from reading C++ file 'CWainwindow.h'
**
...
#error "The header file 'CWainwindow.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_CMainWindow[] = {
    "CMainWindow\0\0onAction_OpenFile()\0"
    "onAction_SaveFile()\0"
};
...
void CMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onAction_OpenFile(); break;
        case 1: _t->onAction_SaveFile(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *CMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IGlobalInterfaces"))
        return static_cast< IGlobalInterfaces*>(const_cast< CMainWindow*>(this));
    if (!strcmp(_clname, "osgGA::GUIEventHandler"))
        return static_cast< osgGA::GUIEventHandler*>(const_cast< CMainWindow*>(this));
