...
ExtrudeGeometryFilter2::ExtrudeGeometryFilter2() :
_maxAngle_deg       ( 5.0 ),
...
void
ExtrudeGeometryFilter2::setStyle( const Style& style )
{
    _style      = style;
    _styleDirty = true;
}
...
void
ExtrudeGeometryFilter2::reset( const FilterContext& context )
{
...
bool
ExtrudeGeometryFilter2::extrudeGeometry(const Geometry*         input,
                                       double                  height,
                                       double                  heightOffset,
                                       bool                    flatten,
                                       osg::Geometry*          walls,
...
void
ExtrudeGeometryFilter2::addDrawable(osg::Drawable*      drawable,
...
bool
ExtrudeGeometryFilter2::process( FeatureList& features, FilterContext& context )
{
...
osg::Node*
ExtrudeGeometryFilter2::push( FeatureList& input, FilterContext& context )
{
    reset( context );
